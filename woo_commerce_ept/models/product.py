...
class product_product(models.Model):
    ...
    woo_product_count = fields.Integer(string='# Sales')
                                       # ,compute='_woo_product_count',store=True)
...
class product_template(models.Model):
    ...
    woo_template_count = fields.Integer(string='# Sales')
                                        # ,compute='_woo_template_count',store=True)