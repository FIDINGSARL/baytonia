{
    ...
    # Dependencies
    'depends': ["eg_bigboss_toolbox", "stock"],
    'data': [
        'wizard/non_moving_product_wizard_views.xml',
        'wizard/non_moving_product_line_view.xml',

        'reports/non_moving_product_line_template.xml',

        "data/non_moving_product_report_cron.xml",
    ...
    'auto_install': False,
    'application': True,
    'live_test_url': 'http://www.emiprotechnologies.com/free-trial?app=non-moving-product-ept&version=11',
    'active': False,
    'price': 49.00,
    'currency': 'EUR',
